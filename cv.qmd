...
- `qtkit`: An R package for quantitative text analysis. [CRAN](https://cran.r-project.org/package=qtkit), [R-Universe](https://qtalr.r-universe.dev/qtkit), [GitHub](https://github.com/qtalr/qtkit), [nixpkgs](https://search.nixos.org/packages?channel=unstable&from=0&size=50&sort=relevance&type=packages&query=qtkit)
